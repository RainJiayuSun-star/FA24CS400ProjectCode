...
public class Backend implements BackendInterface {
     ...
     * <p>
     * Hashmap is used to simplify the algorithm of this method. Basically
     * the hashmap is created with <String, Integer>. String refers to the
     * header name and Integer refers to the position that this header name
     * is stored, since for every .csv file, the header name could be
     * different. The Integer is for songValues list to access specific
     * song information at the position.
     *
    ...
    public void readData(String filename) throws IOException {
        // if the filename section is null, throw exception
        if (filename == null) {
    ...
    public List<String> fiveMost() {
        ...
        // Apply both filters (getRange and setFilter) and add songs
        for (Song song : tree) {
            // Apply the loudness range filter
            boolean filterLoudness = (low == null || song.getLoudness() >= low) &&
